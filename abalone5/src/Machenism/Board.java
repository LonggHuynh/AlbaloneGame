...
public class Board {
	...
	private Mark[][] fields = new Mark[9][9];
	 ...
	 * 
	 * @requires mark != null
	 * @param postions of the marbles to move
	 ...
	 * @param position of selected marble, direction
	 ...
	 * 
	 * @requires pos2 != null
	 * @param postions of the marbles to be compared
	 ...
	 * @param the position of the marble
	 */
